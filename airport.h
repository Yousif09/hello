 ...
 * 2025-11-14
 *
 * Collection of utility functions involving an
 * airport structure
 *
 */
...
/**
 * Computes the distance between two latitude and longitude points
 */
double airDistance(double latA, double latB, double longA, double longB);

/**
 * Outputs a clean formatted airport info
 */
