...
int main(int argc, char **argv) {
   ...
   double lavender[] =         {128, 64,   192, 0.33,   0.66, 0, 0.25};
   double indigo[] =           {75,   0,    130, 0.42, 1.0, 0.0, 0.49};
   double brightOrange[] =     {255,  165,   0,   0.0, 0.35, 1.0, 0.0};
   ...
   const struct CMUnitTest tests[] = {
           ...
           cmocka_unit_test_prestate(testBidirectionalValues, &lavender),
           cmocka_unit_test_prestate(testBidirectionalValues, &indigo),
           cmocka_unit_test_prestate(testBidirectionalValues, &brightOrange),
 };
